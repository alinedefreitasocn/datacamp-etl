"""
Script to get a zip file from the source through request
...
def download_snapshot():
    """
    Download the new dataset (zip) from the
    source and save it in source
    """
...
def save_new_raw_data():
    """
    extracting the CSV file from the source
    and saving it in the raw folder
